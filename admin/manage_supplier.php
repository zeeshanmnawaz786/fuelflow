                ...
                <tbody>
                  ...
                  foreach ($record as $key) { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" onclick="editForm(event, <?php echo $key['id']; ?>,'edit_supplier.php')" class="btn btn-primary waves-effect waves-light"><i class="fa fa-edit" aria-hidden="true"></i>

                        </a>


                        <a href="#" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?') && delForm(event, <?php echo $key['id']; ?>,'app/supplier_crud.php' );"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
  ...
  <script>
    setTimeout(function() {
      swal({
        ...
        window.location = "manage_supplier.php";
      }, 1000);
    });
  </script>
